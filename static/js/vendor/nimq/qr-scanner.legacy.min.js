...
(function (c, e) {
  ...
  class c {
    ...
    //     // a = this.$video
    //     // Kích thước ô vuông: 1/2 cạnh ngắn
    //     const side = Math.round(0.5 * Math.min(a.videoWidth, a.videoHeight));

    //     // Dịch sang trái thêm: tăng marginRight lên (vd: 10% chiều ngang)
    //     const marginRight = Math.round(a.videoWidth * 0.10);

    //     // Đưa ô quét gần lên trên: cách top 5% chiều cao
    //     const marginTop = Math.round(a.videoHeight * 0.05);

    //     // X: vẫn bám bên phải nhưng chừa nhiều hơn để vào trong
    //     const x = Math.max(0, a.videoWidth - side - marginRight);

    //     // Y: cố định theo marginTop (gần top)
    //     const y = marginTop;
    ...
    // a = this.$video
        ...
        return {
            x: 0,                      // bắt đầu từ mép trái
            y: 0,                      // bắt đầu từ mép trên
            width: a.videoWidth,       // phủ 100% chiều ngang video
            height: a.videoHeight,     // phủ 100% chiều dọc video
            downScaledWidth: this._legacyCanvasSize,
            downScaledHeight: this._legacyCanvasSize,
        };
    }
